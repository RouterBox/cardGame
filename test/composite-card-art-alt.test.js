...
test('AC3: design/cards/alt-art-briefs.md names at least 10 alt briefs (sanity check on fixture)', () => {
  assert.ok(
    ALT_TITLES.length >= 10,
    `expected at least 10 alt briefs (10 existed when written), found ${ALT_TITLES.length}`
  );
});
