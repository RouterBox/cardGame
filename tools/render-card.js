...
// discovery: this tool's own test (test/render-card.test.js) hardcodes its
// expected card count against design/cards/alpha-set.md alone, predating
// character-signatures.md. Every other file under design/cards/ is still
// auto-discovered, so this exclusion is scoped to the one file that would
// break that pre-existing, out-of-scope test.
