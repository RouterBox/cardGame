# cardgame-lib-markdown-section-parser-dedup: Extract the duplicated H2/H3-section-splitting and paragraph-extraction helpers shared by cardGame's 4 newer lib/parse-*-markdown.js files into one shared module

## Header

- unit: cardgame-lib-markdown-section-parser-dedup
