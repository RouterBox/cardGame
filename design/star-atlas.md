...
holds is, in a real sense, an extension of this one. In the Cinderglass
War, no battles were fought on or from Fenwreath, and the Mireth Bloom
raised no fleet and took no side. It simply grew, patiently, over
whichever battlefields the war's other four civilizations abandoned, and
Fenwreath's own vaults now hold more wreckage inherited from that one war,
quietly overgrown with spore and root, than from anything else in Expanse
history.
...
the right coordinates. During the Cinderglass War, oath-sworn fleets
launched from Ansareth moved to seize the wormhole junctions the
Reach-versus-Assembly fighting depended on — not to win the war for either
side, but because Ansareth's own seers warned that a war fought that long
over a First Weave relic risked provoking a second Sundering. Fleets
crewed on Ansareth hold several of those junctions still, imperfectly, to
this day.
